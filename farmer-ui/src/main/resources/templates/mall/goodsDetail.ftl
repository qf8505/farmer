...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<link type="text/css" href="${ctx}/plugin/farmer/css/optstyle.css" rel="stylesheet" />
		<link type="text/css" href="${ctx}/plugin/farmer/css/style.css" rel="stylesheet" />
		...
		<script type="text/javascript" src="${ctx}/plugin/AmazeUI-2.4.2/assets/js/amazeui.js"></script>
		<script type="text/javascript" src="${ctx}/plugin/farmer/js/jquery.imagezoom.min.js"></script>
		<script type="text/javascript" src="${ctx}/plugin/farmer/js/jquery.flexslider.js"></script>
		<script type="text/javascript" src="${ctx}/plugin/farmer/js/list.js"></script>
				...
				<div class="scoll">
					<section class="slider">
						<div class="flexslider">
							<ul class="slides">
								<li>
									<img src="${ctx}/plugin/farmer/images/01.jpg" title="pic" />
								</li>
								<li>
									<img src="${ctx}/plugin/farmer/images/02.jpg" />
								</li>
								<li>
									<img src="${ctx}/plugin/farmer/images/03.jpg" />
								</li>
							</ul>
						</div>
					</section>
					...
					<div class="clearfixLeft" id="clearcontent">
						...
						<div class="box">
							...
							<div class="tb-booth tb-pic tb-s310">
								<a href="${ctx}/plugin/farmer/images/01.jpg"><img src="${ctx}/plugin/farmer/images/01_mid.jpg" alt="细节展示放大镜特效" rel="${ctx}/plugin/farmer/images/01.jpg" class="jqzoom" /></a>
							</div>
							<ul class="tb-thumb" id="thumblist">
								<li class="tb-selected">
									<div class="tb-pic tb-s40">
										<a href="#"><img src="${ctx}/plugin/farmer/images/01_small.jpg" mid="${ctx}/plugin/farmer/images/01_mid.jpg" big="${ctx}/plugin/farmer/images/01.jpg"></a>
									</div>
								</li>
								<li>
									<div class="tb-pic tb-s40">
										<a href="#"><img src="${ctx}/plugin/farmer/images/02_small.jpg" mid="${ctx}/plugin/farmer/images/02_mid.jpg" big="${ctx}/plugin/farmer/images/02.jpg"></a>
									</div>
								</li>
								<li>
									<div class="tb-pic tb-s40">
										<a href="#"><img src="${ctx}/plugin/farmer/images/03_small.jpg" mid="${ctx}/plugin/farmer/images/03_mid.jpg" big="${ctx}/plugin/farmer/images/03.jpg"></a>
									</div>
								</li>
							</ul>
						</div>
										...
										<div class="theme-popbod dform">
											<form class="theme-signin" name="loginform" action="" method="post">
												...
												<div class="theme-signin-right">
													<div class="img-info">
														<img src="${ctx}/plugin/farmer/images/songzi.jpg" />
													</div>
													<div class="text-info">
				...
				<div class="match">
					...
					<div class="match-comment">
						<ul class="like_list">
							<li>
								<div class="s_picBox">
									<a class="s_pic" href="#"><img src="${ctx}/plugin/farmer/images/cp.jpg"></a>
							...
							<li>
								<div class="s_picBox">
									<a class="s_pic" href="#"><img src="${ctx}/plugin/farmer/images/cp2.jpg"></a>
					    ...
					    <div class="mc"> 
						     <ul>					    
						     	<div class="mt">            
							      ...
							      <li class="first">
							      	<div class="p-img">                    
							      		<a  href="#"> <img class="" src="${ctx}/plugin/farmer/images/browse1.jpg"> </a>               
							      	</div>
								...
								<div class="am-tab-panel am-fade am-in am-active">
									...
									<div class="details">
										...
										<div class="twlistNews">
											<img src="${ctx}/plugin/farmer/images/tw1.jpg" />
											<img src="${ctx}/plugin/farmer/images/tw2.jpg" />
											<img src="${ctx}/plugin/farmer/images/tw3.jpg" />
											<img src="${ctx}/plugin/farmer/images/tw4.jpg" />
											<img src="${ctx}/plugin/farmer/images/tw5.jpg" />
											<img src="${ctx}/plugin/farmer/images/tw6.jpg" />
											<img src="${ctx}/plugin/farmer/images/tw7.jpg" />
										</div>
									</div>
									<div class="clear"></div>
								...
								<div class="am-tab-panel am-fade">
									...
									<ul class="am-comments-list am-comments-list-flip">
										<li class="am-comment">
											<!-- 评论容器 -->
											<a href="">
												<img class="am-comment-avatar" src="${ctx}/plugin/farmer/images/hwbn40x40.jpg" />
												<!-- 评论者头像 -->
											</a>
										...
										<ul class="am-avg-sm-2 am-avg-md-3 am-avg-lg-4 boxes">
											<li>
												<div class="i-pic limit">
													<img src="${ctx}/plugin/farmer/images/imgsearch1.jpg" />
