...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<link href="${ctx}/plugin/farmer/css/seastyle.css" rel="stylesheet" type="text/css" />

		<script type="text/javascript" src="${ctx}/plugin/basic/js/jquery-1.7.min.js"></script>
		<script type="text/javascript" src="${ctx}/plugin/farmer/js/script.js"></script>
	</head>
							...
							<div class="search-side">
								...
								<li>
									<div class="i-pic check">
										<img src="${ctx}/plugin/farmer/images/cp.jpg" />
								...
								<li>
									<div class="i-pic check">
										<img src="${ctx}/plugin/farmer/images/cp2.jpg" />
