...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<link href="${ctx}/plugin/farmer/css/jsstyle.css" rel="stylesheet" type="text/css" />

		<script type="text/javascript" src="${ctx}/plugin/farmer/js/address.js"></script>
				...
				<div class="paycont">
                   ...
                   <span class="buy-user">艾迪 </span>
								...
								<div class="address-right">
									<a href="${ctx}/plugin/person/address.html">
                   ...
                   <span class="buy-user">艾迪 </span>
					...
					<div class="logistics">
						<h3>选择支付方式</h3>
						<ul class="pay-list">
							<li class="pay card"><img src="${ctx}/plugin/farmer/images/wangyin.jpg" />银联<span></span></li>
							<li class="pay qq"><img src="${ctx}/plugin/farmer/images/weizhifu.jpg" />微信<span></span></li>
							<li class="pay taobao"><img src="${ctx}/plugin/farmer/images/zhifubao.jpg" />支付宝<span></span></li>
						</ul>
					</div>
					<div class="clear"></div>
