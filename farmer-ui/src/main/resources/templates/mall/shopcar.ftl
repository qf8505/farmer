...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<link href="${ctx}/plugin/farmer/css/cartstyle.css" rel="stylesheet" type="text/css" />
		<link href="${ctx}/plugin/farmer/css/optstyle.css" rel="stylesheet" type="text/css" />

		<script type="text/javascript" src="${ctx}/plugin/farmer/js/jquery.js"></script>
	...
	<body>
			...
			<div class="concent">
									...
									<li class="td td-item">
										<div class="item-pic">
											<a href="#" target="_blank" data-title="美康粉黛醉美东方唇膏口红正品 持久保湿滋润防水不掉色护唇彩妆" class="J_MakePoint" data-point="tbcart.8.12">
												<img src="${ctx}/plugin/farmer/images/kouhong.jpg_80x80.jpg" class="itempic J_ItemImg"></a>
										</div>
										<div class="item-info">
				...
				<div class="float-bar-wrapper">
					...
					<div class="float-bar-right">
						...
						<div class="btn-area">
							<a href="${ctx}/index/pay" id="J_Go" class="submit-btn submit-btn-disabled" aria-label="请注意如果没有选择宝贝，将无法结算">
								<span>结&nbsp;算</span></a>
						</div>
					</div>
				...
				<div class="theme-popbod dform">
					<form class="theme-signin" name="loginform" action="" method="post">
						...
						<div class="theme-signin-right">
							<div class="img-info">
								<img src="${ctx}/plugin/farmer/images/kouhong.jpg_80x80.jpg" />
							</div>
							<div class="text-info">
		...
		<!--引导 -->
		<div class="navCir">
			<li><a href="${ctx}"><i class="am-icon-home "></i>首页</a></li>
			<li><a href="${ctx}"><i class="am-icon-list"></i>分类</a></li>
			<li class="active"><a href="${ctx}/index/shopcar"><i class="am-icon-shopping-basket"></i>购物车</a></li>	
